...
class LoginForm extends Component {
  ...
  generateOTP = async () => {
    ...
    const url = "https://b71b-103-137-198-235.ngrok-free.app/loginOtp";
    const options = {
      method: "POST",
      headers: {
  ...
  verifyOTP = async () => {
    ...
    const url = "https://b71b-103-137-198-235.ngrok-free.app/loginVerifyOtp"; // Replace with your server-side API endpoint for verifying OTP
